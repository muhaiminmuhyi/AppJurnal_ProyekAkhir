<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    foreach($pakan as $row):
                        ?>
                            <tr>
                                ...
                                <td><?= $row['satuan'];?></td>
                                <td>
                                  <a class="btn btn-warning btn-sm" href="<?= base_url('pakan/editpakan/'.$row['id_pakan']) ?>" role="button">
                                    <i class="icon-edit"></i> Edit
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('pakan/deletepakan/'.$row['id_pakan']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('Pakan') ?>" class="btn btn-warning" id="tmbh">Tambah Data Pakan</a>
                    </div>
                  </div>
              </div>
            </div> 
