<main class="col-md-9 ms-sm-auto col-lg-12 px-md-4">
                    ...
                    foreach($kandang as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a class="btn btn-warning btn-sm" href="<?= base_url('kandang/editkandang/'.$row['id_kandang']) ?>" role="button">
                                    <i class="icon-edit"></i> Edit
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('kandang/deletekandang/'.$row['id_kandang']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('Kandang') ?>" class="btn btn-warning" id="tmbh">Tambah Data Kandang</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('Kandang/ListKandang') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan ID Kandang <b>"
