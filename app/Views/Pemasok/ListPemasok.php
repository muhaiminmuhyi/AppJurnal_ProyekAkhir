<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    foreach($pemasok as $row):
                        ?>
                            <tr>
                                ...
                                <td><?= $row['nm_pemasok'];?></td>
                                <td><?= $row['alamat'];?></td>
                                <td><?= $row['no_telp'];?></td>
                                <td><?= $row['email'];?></td>
                                <td>
                                  <a class="btn btn-warning btn-sm" href="<?= base_url('pemasok/editpemasok/'.$row['id_pemasok']) ?>" role="button">
                                    <i class="icon-edit"></i> Edit
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('pemasok/deletepemasok/'.$row['id_pemasok']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('pemasok') ?>" class="btn btn-warning" id="tmbh">Tambah Data Pemasok</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('pemasok/Listpemasok') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan ID pemasok <b>"
